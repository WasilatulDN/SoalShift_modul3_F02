...
void *thread1(void *arg)
{
        ...
        {
                snprintf(buffer3, sizeof(buffer3), "ps -aux | head -10 > /home/ihdiannaja2911/Documents/FolderProses1/SimpanProses1.txt");
                system(buffer3);
        }
        else if(pthread_equal(id,tid[1]))
        {
                snprintf(buffer4, sizeof(buffer4), "ps -aux | head -10 > /home/ihdiannaja2911/Documents/FolderProses2/SimpanProses2.txt");
                system(buffer4);
...
void *thread2(void *arg)
{
        ...
        {
                snprintf(buffer, sizeof(buffer), "zip KompresProses1.zip /home/ihdiannaja2911/Documents/FolderProses1/SimpanProses1.txt");
                system(buffer);
        }
        else if(pthread_equal(id2,tid2[1]))
        {
                snprintf(buffer2, sizeof(buffer2), "zip KompresProses2.zip /home/ihdiannaja2911/Documents/FolderProses2/SimpanProses2.txt");
                system(buffer2);
        }
        status=2;
        return NULL;
...
void *thread3(void *arg)
{
        ...
        {
                snprintf(buf, sizeof(buf), "rm /home/ihdiannaja2911/Documents/FolderProses1/SimpanProses1.txt");
                system(buf);
        }
        else if(pthread_equal(id3,tid3[1]))
        {
                snprintf(buf2, sizeof(buf2), "rm /home/ihdiannaja2911/Documents/FolderProses2/SimpanProses2.txt");
                system(buf2);
        }
        status=3;
        return NULL;
